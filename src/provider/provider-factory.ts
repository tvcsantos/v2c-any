 ...
 *
 * Extends the generic Factory interface to specialize it for provider
 * creation.
 *
 * @template Options - The configuration options type required to create a
 * provider
 ...
 *
 * Extends the generic Factory interface to specialize it for RPC MQTT request
 * provider creation.
 *
 * @template Options - The configuration options type required to create an RPC
 * MQTT request provider
 * @template T - The type of request message the created providers will
 * generate
 */
